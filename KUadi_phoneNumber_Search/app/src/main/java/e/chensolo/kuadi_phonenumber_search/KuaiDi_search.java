...
public class KuaiDi_search extends ListActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kuaidi_main);
                ...
                public void run(){
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            SimpleAdapter simpleAdapter = new SimpleAdapter(KuaiDi_search.this, list,
                                    R.layout.item_list, from, to);
                            setListAdapter(simpleAdapter);
                            //假如没有数据，提醒用户
                            if ( lv.getCount() == 0 ) {
                                Toast.makeText(KuaiDi_search.this, "还没有数据", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
